...
const newUser = document.querySelector('#createdBy')
...
//       asig vanándole ellor de la propiedad 'description' del objeto ToDo.
...
function addToDo() {
  // 1) Seleccionar el input toDoInput y obtener su valor
